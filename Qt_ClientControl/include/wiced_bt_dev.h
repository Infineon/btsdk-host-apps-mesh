...
#ifndef BTM_EIR_UUIDS
#define BTM_EIR_UUIDS
enum
{
...
enum wiced_bt_dev_power_mgmt_status_e
{
    ...
    WICED_POWER_STATE_SMART_SNIFF                                 /**< Smart Sniff */
};
...
/*BR channel map*/
#define BR_CHANNEL_MAP_LEN    10
typedef uint8_t wiced_bt_br_chnl_map_t[BR_CHANNEL_MAP_LEN];
...
{
    CLEAR_LINK_QUALITY_STATS            = 0,                  /**< clear link quality stats */
    READ_LINK_QUALITY_STATS             = 1,                  /**< read link quality stats */
    READ_THEN_CLEAR_LINK_QUALITY_STATS  = 2,                  /**< read then clear link quality stats */
};
...
* @return          wiced_result_t
*
* Note: Please use wiced_bt_ble_set_adv_tx_power. To support existing apps we kept this API
**/
wiced_result_t wiced_bt_dev_set_adv_tx_power(INT8 power);

/**
* Function         wiced_bt_dev_read_adv_tx_power
*
...
*                  WICED_BT_BUSY if command is already in progress
*
* Note: Please use wiced_bt_ble_read_adv_tx_power. To support existing apps we kept this API
*/
wiced_result_t wiced_bt_dev_read_adv_tx_power(wiced_bt_dev_cmpl_cback_t *p_cback);
 ...
 * @param[in]       action            : CLEAR_LINK_QUALITY_STATS = reset the link quality statistics to 0, READ_LINK_QUALITY_STATS = read link quality statistics,
                                        READ_THEN_CLEAR_LINK_QUALITY_STATS = read link quality statistics, then clear it
