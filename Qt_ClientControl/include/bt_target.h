...
/* BSA_SPECIFIC */
#ifndef BT_BRCM_I2SPCM_ENABLE_FLAG
#define BT_BRCM_I2SPCM_ENABLE_FLAG   FALSE /* use HCI_BRCM_I2SPCM_I2S_ENABLE if TRUE or HCI_BRCM_I2SPCM_I2S_DISABLE if FALSE */
#endif

#ifndef BT_BRCM_I2SPCM_SLAVE_ROLE
#define BT_BRCM_I2SPCM_SLAVE_ROLE    FALSE /* use HCI_BRCM_I2SPCM_IS_SLAVE if TRUE or HCI_BRCM_I2SPCM_IS_MASTER if FALSE */
#endif

/* Config PCM time slots for muti-SCO connections */
#ifndef BTM_BRCM_PCM_CONFIG_TIME_SLOT
#define BTM_BRCM_PCM_CONFIG_TIME_SLOT   FALSE
#endif
...
/* BSA_SPECIFIC */
/* START code-block - Configure SCO and PCM interfaces at bsa_server startup */
#ifndef BTM_SCO_PCM_INTF
#define BTM_SCO_PCM_INTF FALSE
#else
/* SCO routing: 0=PCM(default) 1=UART 2=CODEC 3=I2S */
#ifndef BTM_SCO_ROUTING
#define BTM_SCO_ROUTING 0
#endif
/* PCM interface rate: 0=128 kHz(default) 1=256 kHz 2=512 kHz 3=1024 kHz 4=2048 kHz */
#ifndef BTM_PCM_INTF_RATE
#define BTM_PCM_INTF_RATE 0
#endif
/* PCM frame type: 0=short(default) 1=long */
#ifndef BTM_PCM_FRAME_TYPE
#define BTM_PCM_FRAME_TYPE 0
#endif
/* PCM sync mode: 0=slave(default) 1=master */
#ifndef BTM_PCM_SYNC_MODE
#define BTM_PCM_SYNC_MODE 0
#endif
/* PCM clock mode: 0=slave(default) 1=master */
#ifndef BTM_PCM_CLOCK_MODE
#define BTM_PCM_CLOCK_MODE 0
#endif
#endif /* BTM_SCO_PCM_INTF */
/* END code-block - Configure SCO and PCM interfaces at bsa_server startup */
...
/* BSA_SPECIFIC */
/* This is set to prevent role switch attempt if remote device reject rolw switch */
#ifndef BTM_PRVENT_ROLE_SWITCH_IF_NOT_ALLOWED
#define BTM_PRVENT_ROLE_SWITCH_IF_NOT_ALLOWED      FALSE
#endif
...
#define SDP_MAX_RECORDS             28 /* BSA_SPECIFIC */
#endif
...
#define MAX_RFC_PORTS               20 /* BSA_SPECIFIC */
#endif
...
**
******************************************************************************/
/* Maximum number of simultaneous BIP connections */
#ifndef BIP_MAX_CONN
#define BIP_MAX_CONN            2
#endif

/* Maximum number of responders allowed to connect simultaneously */
#ifndef BTA_BIC_MAX_CONN
#define BTA_BIC_MAX_CONN        2
#endif

/* Maximum number of initators allowed to connect simultaneously */
#ifndef BTA_BIS_MAX_CONN
#define BTA_BIS_MAX_CONN        2
#endif
...
#define AVCT_NUM_LINKS              AVDT_NUM_LINKS  /* BSA_SPECIFIC */
#endif

/* Number of simultaneous AVCTP connections. */
#ifndef AVCT_NUM_CONN
#define AVCT_NUM_CONN               AVCT_NUM_LINKS  /* BSA_SPECIFIC */
#endif
...
#define AVRC_1_6_INCLUDED           TRUE /* BSA_SPECIFIC */
#endif

#ifndef AVRC_COVER_ART_INCLUDED
#define AVRC_COVER_ART_INCLUDED      FALSE
#endif
...
#if (!defined(BTA_AVK_INCLUDED) || (BTA_AVK_INCLUDED == FALSE))
#undef BTA_AVK_AV_AUDIO_RELAY
#else
/* BSA_SPECIFIC */
#ifndef BTA_AVK_AV_AUDIO_RELAY
#define BTA_AVK_AV_AUDIO_RELAY FALSE
#endif
#endif

#ifndef BSA_AV_AVK_INCLUDED
#define BSA_AV_AVK_INCLUDED TRUE
#endif
...
#define BTA_AVK_NUM_STRS         BTA_AVK_MAX_NUM_CONN
#endif

/* maximum number of peer AVRCP connecitons for AVK (this is used for AVK only at this time) */
/* AV internally manages AVRCP */
#ifndef BTA_RC_MAX_CONN
#define BTA_RC_MAX_CONN         BTA_AVK_MAX_NUM_CONN
#endif

#ifndef BTA_BROWSE_MTU
#define BTA_BROWSE_MTU          (1008)
#endif
...
#define BTA_FM_INCLUDED FALSE  /* BSA_SPECIFIC */
#endif
...
/* BSA_SPECIFIC */
#define BTE_CHECK_AUTH_FOR_SDP(bd_addr) bsa_sv_check_auth_for_sdp(bd_addr)
