...
#if (defined BTM_BLE_MAKE_FALSE_LL_PRIVACY && BTM_BLE_MAKE_FALSE_LL_PRIVACY == TRUE)
#define HCI_LE_ENHANCED_PRIVACY_SUPPORTED(x)       0
#else
...
/* Supported Commands Byte 33 */
#define HCI_SUPP_COMMANDS_READ_EXTEND_PAGE_TOUT_MASK            0x01
#define HCI_SUPP_COMMANDS_READ_EXTEND_PAGE_TOUT_OFF             33
#define HCI_READ_EXTEND_PAGE_TOUT_SUPPORTED(x)  ((x)[HCI_SUPP_COMMANDS_READ_EXTEND_PAGE_TOUT_OFF] & HCI_SUPP_COMMANDS_READ_EXTEND_PAGE_TOUT_MASK)

#define HCI_SUPP_COMMANDS_WRITE_EXTEND_PAGE_TOUT_MASK           0x02
#define HCI_SUPP_COMMANDS_WRITE_EXTEND_PAGE_TOUT_OFF            33
#define HCI_WRITE_EXTEND_PAGE_TOUT_SUPPORTED(x) ((x)[HCI_SUPP_COMMANDS_WRITE_EXTEND_PAGE_TOUT_OFF] & HCI_SUPP_COMMANDS_WRITE_EXTEND_PAGE_TOUT_MASK)

#define HCI_SUPP_COMMANDS_READ_EXTEND_INQ_LNG_MASK              0x04
#define HCI_SUPP_COMMANDS_READ_EXTEND_INQ_LNG_OFF               33
#define HCI_READ_EXTEND_INQ_LNG_SUPPORTED(x)    ((x)[HCI_SUPP_COMMANDS_READ_EXTEND_INQ_LNG_OFF] & HCI_SUPP_COMMANDS_READ_EXTEND_INQ_LNG_MASK)

#define HCI_SUPP_COMMANDS_WRITE_EXTEND_INQ_LNG_MASK             0x08
#define HCI_SUPP_COMMANDS_WRITE_EXTEND_INQ_LNG_OFF              33
#define HCI_WRITE_EXTEND_INQ_LNG_SUPPORTED(x)   ((x)[HCI_SUPP_COMMANDS_WRITE_EXTEND_INQ_LNG_OFF] & HCI_SUPP_COMMANDS_WRITE_EXTEND_INQ_LNG_MASK)
...
#define HCI_SUPP_COMMANDS_LE_RC_CONN_PARAM_UPD_NEG_RPY_MASK     0x20
#define HCI_SUPP_COMMANDS_LE_RC_CONN_PARAM_UPD_NEG_RPY_OFF           33
#define HCI_LE_RC_CONN_PARAM_UPD_NEG_RPY_SUPPORTED(x)   ((x)[HCI_SUPP_COMMANDS_LE_RC_CONN_PARAM_UPD_NEG_RPY_OFF] & HCI_SUPP_COMMANDS_LE_RC_CONN_PARAM_UPD_NEG_RPY_MASK)

#define HCI_SUPP_COMMANDS_LE_SET_DATA_LNG_MASK                  0x40
#define HCI_SUPP_COMMANDS_LE_SET_DATA_LNG_OFF                   33
#define HCI_LE_SET_DATA_LNG_SUPPORTED(x)    ((x)[HCI_SUPP_COMMANDS_LE_SET_DATA_LNG_OFF] & HCI_SUPP_COMMANDS_LE_SET_DATA_LNG_MASK)

#define HCI_SUPP_COMMANDS_LE_READ_SUGG_DFLT_DATA_LNG_MASK       0x80
#define HCI_SUPP_COMMANDS_LE_READ_SUGG_DFLT_DATA_LNG_OFF        33
#define HCI_LE_READ_SUGG_DFLT_DATA_LNG_SUPPORTED(x) ((x)[HCI_SUPP_COMMANDS_LE_READ_SUGG_DFLT_DATA_LNG_OFF] & HCI_SUPP_COMMANDS_LE_READ_SUGG_DFLT_DATA_LNG_MASK)

/* Supported Commands Byte 34 */
#define HCI_SUPP_COMMANDS_LE_WRITE_SUGG_DFLT_DATA_LNG_MASK      0x01
#define HCI_SUPP_COMMANDS_LE_WRITE_SUGG_DFLT_DATA_LNG_OFF       34
#define HCI_LE_WRITE_SUGG_DFLT_DATA_LNG_SUPPORTED(x)    ((x)[HCI_SUPP_COMMANDS_LE_WRITE_SUGG_DFLT_DATA_LNG_OFF] & HCI_SUPP_COMMANDS_LE_WRITE_SUGG_DFLT_DATA_LNG_MASK)

#define HCI_SUPP_COMMANDS_LE_READ_LOC_P_256_PUBL_KEY_MASK       0x02
#define HCI_SUPP_COMMANDS_LE_READ_LOC_P_256_PUBL_KEY_OFF        34
#define HCI_LE_READ_LOC_P_256_PUBL_KEY_SUPPORTED(x) ((x)[HCI_SUPP_COMMANDS_LE_READ_LOC_P_256_PUBL_KEY_OFF] & HCI_SUPP_COMMANDS_LE_READ_LOC_P_256_PUBL_KEY_MASK)

#define HCI_SUPP_COMMANDS_LE_GENERATE_DH_KEY_MASK               0x04
#define HCI_SUPP_COMMANDS_LE_GENERATE_DH_KEY_OFF                34
#define HCI_LE_GENERATE_DH_KEY_SUPPORTED(x) ((x)[HCI_SUPP_COMMANDS_LE_GENERATE_DH_KEY_OFF] & HCI_SUPP_COMMANDS_LE_GENERATE_DH_KEY_MASK)

#define HCI_SUPP_COMMANDS_LE_ADD_DEV_TO_RSLVN_LIST_MASK         0x08
#define HCI_SUPP_COMMANDS_LE_ADD_DEV_TO_RSLVN_LIST_OFF          34
#define HCI_LE_ADD_DEV_TO_RSLVN_LIST_SUPPORTED(x)   ((x)[HCI_SUPP_COMMANDS_LE_ADD_DEV_TO_RSLVN_LIST_OFF] & HCI_SUPP_COMMANDS_LE_ADD_DEV_TO_RSLVN_LIST_MASK)

#define HCI_SUPP_COMMANDS_LE_RMV_DEV_FROM_RSLVN_LIST_MASK       0x10
#define HCI_SUPP_COMMANDS_LE_RMV_DEV_FROM_RSLVN_LIST_OFF        34
#define HCI_LE_RMV_DEV_FROM_RSLVN_LIST_SUPPORTED(x) ((x)[HCI_SUPP_COMMANDS_LE_RMV_DEV_FROM_RSLVN_LIST_OFF] & HCI_SUPP_COMMANDS_LE_RMV_DEV_FROM_RSLVN_LIST_MASK)

#define HCI_SUPP_COMMANDS_LE_CLEAR_RSLVN_LIST_MASK              0x20
#define HCI_SUPP_COMMANDS_LE_CLEAR_RSLVN_LIST_OFF               34
#define HCI_LE_CLEAR_RSLVN_LIST_SUPPORTED(x)    ((x)[HCI_SUPP_COMMANDS_LE_CLEAR_RSLVN_LIST_OFF] & HCI_SUPP_COMMANDS_LE_CLEAR_RSLVN_LIST_MASK)

#define HCI_SUPP_COMMANDS_LE_READ_RSLVN_LIST_SIZE_MASK          0x40
#define HCI_SUPP_COMMANDS_LE_READ_RSLVN_LIST_SIZE_OFF           34
#define HCI_LE_READ_RSLVN_LIST_SIZE_SUPPORTED(x)    ((x)[HCI_SUPP_COMMANDS_LE_READ_RSLVN_LIST_SIZE_OFF] & HCI_SUPP_COMMANDS_LE_READ_RSLVN_LIST_SIZE_MASK)

#define HCI_SUPP_COMMANDS_LE_READ_PEER_RSLVBL_ADDR_MASK         0x80
#define HCI_SUPP_COMMANDS_LE_READ_PEER_RSLVBL_ADDR_OFF          34
#define HCI_LE_READ_PEER_RSLVBL_ADDR_SUPPORTED(x)   ((x)[HCI_SUPP_COMMANDS_LE_READ_PEER_RSLVBL_ADDR_OFF] & HCI_SUPP_COMMANDS_LE_READ_PEER_RSLVBL_ADDR_MASK)

/* Supported Commands Byte 35, only bits 0 - 3 are defined */
#define HCI_SUPP_COMMANDS_LE_READ_LOCAL_RSLVBL_ADDR_MASK        0x01
#define HCI_SUPP_COMMANDS_LE_READ_LOCAL_RSLVBL_ADDR_OFF         35
#define HCI_LE_READ_LOCAL_RSLVBL_ADDR_SUPPORTED(x)  ((x)[HCI_SUPP_COMMANDS_LE_READ_LOCAL_RSLVBL_ADDR_OFF] & HCI_SUPP_COMMANDS_LE_READ_LOCAL_RSLVBL_ADDR_MASK)

#define HCI_SUPP_COMMANDS_LE_SET_ADDR_RSLTN_MASK                0x02
#define HCI_SUPP_COMMANDS_LE_SET_ADDR_RSLTN_OFF                 35
#define HCI_LE_SET_ADDR_RSLTN_SUPPORTED(x)  ((x)[HCI_SUPP_COMMANDS_LE_SET_ADDR_RSLTN_OFF] & HCI_SUPP_COMMANDS_LE_SET_ADDR_RSLTN_MASK)

#define HCI_SUPP_COMMANDS_LE_SET_RSLVBL_PRIV_ADDR_TOUT_MASK     0x04
#define HCI_SUPP_COMMANDS_LE_SET_RSLVBL_PRIV_ADDR_TOUT_OFF      35
#define HCI_LE_SET_RSLVBL_PRIV_ADDR_TOUT_SUPPORTED(x)   ((x)[HCI_SUPP_COMMANDS_LE_SET_RSLVBL_PRIV_ADDR_TOUT_OFF] & HCI_SUPP_COMMANDS_LE_SET_RSLVBL_PRIV_ADDR_TOUT_MASK)

#define HCI_SUPP_COMMANDS_LE_READ_MAX_DATA_LNG_MASK             0x08
#define HCI_SUPP_COMMANDS_LE_READ_MAX_DATA_LNG_OFF              35
#define HCI_LE_READ_MAX_DATA_LNG_SUPPORTED(x)   ((x)[HCI_SUPP_COMMANDS_LE_READ_MAX_DATA_LNG_OFF] & HCI_SUPP_COMMANDS_LE_READ_MAX_DATA_LNG_MASK)
